  ...
  return (
    ...
    >
      ...
      <motion.h1
        ...
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.5, delay: 0.7 }}
        className="text-4xl lg:text-6xl font-bold flex flex-col text-designColor"
      >
        Mohammad Selim
      ...
      >
        I am a Front End developer with 2+ years of Learning experience in Front end development. I have a
        strong foundation in front-end & back-end development and am skilled in
        creating user-friendly and responsive web applications using React and
        its ecosystem.{" "}
        <a href="https://selimnill-portfolio.netlify.app/" target="blank">
      ...
      <motion.a
        ...
        href="https://github.com/mohammad-selim03"
        target="_blank"
